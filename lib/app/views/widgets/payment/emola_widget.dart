...
class PagamentoEmolaHelper {
  static void showPagamentoEmola(BuildContext context) {
    showModalBottomSheet(
      context: context,
      builder: (BuildContext context) {
        return PagamentoEmolaWidget();
      },
    );
  }
}

class PagamentoEmolaWidget extends StatefulWidget {

  @override
  State<PagamentoEmolaWidget> createState() => _PagamentoEmolaWidgetState();
}

class _PagamentoEmolaWidgetState extends State<PagamentoEmolaWidget> {
